...
Route::get('/otp_verification_view',         [FRONTEND\PricingController::class, 'otp'])->name('show.otp');

Route::post('/otp_verification_func',  [FRONTEND\PricingController::class, 'otp_verification']);
Route::post('/otp_resend',  [FRONTEND\PricingController::class, 'otp_resend']);
